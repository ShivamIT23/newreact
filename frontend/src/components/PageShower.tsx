...
export default function PageShower({
  ...
  return (
    <div className="min-w-48 h-6 flex absolute top-4 left-24  font-normal text-lg items-center gap-4">
      ...
      <p className="min-w-20 h-6 flex items-center">{typeof children === 'string' ?children.toUpperCase() : children}</p>
    </div>
  );
}
